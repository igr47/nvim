return {
  ...
  config = function()
    ...
    local servers = {
      ...
      -- Python (using pyright which is more modern than pylsp)
      pyright = {
        capabilities = capabilities,
      ...
      sqlls = {
        ...
        settings = {
          sqlLanguageServer = {
            dialect = 'generic', -- Change to 'postgresql', 'mysql', 'sqlite', etc. as needed
          },
        },
      },
      
      -- Additional useful servers for your workflow
      html = { 
    ...
    -- Remove the old pylsp if you're using pyright (pyright is better)
    -- If you prefer to keep both, uncomment the line below:
    -- servers.pylsp = { ... } -- (your existing pylsp config)
    ...
    vim.list_extend(ensure_installed, {
      ...
      'sqlls', -- SQL LSP
      'prettier',    -- For formatting JS/TS/JSON/YAML
